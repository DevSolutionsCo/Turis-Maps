...
public class Turista implements Serializable{
    ...
    private String url_nombreUser;

    public String getUrl_nombreUser() {
        return url_nombreUser;
    }

    public void setUrl_nombreUser(String url_nombreUser) {
        this.url_nombreUser = url_nombreUser;
    }
