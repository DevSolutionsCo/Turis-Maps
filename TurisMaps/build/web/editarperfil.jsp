...
<body>
    <div  class="signUp-box">
        <h2>Editar Perfil</h2>
        <form id="signUp"action="usuario.jsp" method="post">
            <div class="user-box">
                <input type="text" class="inputs" name="nombre_user" id="nombre_user" value="${param.nombre_user}" ${param.readonly}>
                <label class="labels">Nombre de Usuario</label>
            </div>
            <div class="user-box">
                <input type="email" class="inputs" name="correo" id="correo" value="${param.correo}">
            ...
            <div class="user-box">
                ...
                <label class="labels">Contraseña</label>
                        ...
                        <div class="user-box">
                <input type="password" name="contraseña_valid" class="inputs" id="contraseña_valid">
                <label class="labels">Confirmar contraseña</label>
            </div>
            <p class="warnings" id="warnings"></p>
            <script src="signUp.js"></script>
            <div class="btn-iniciar">
                <input id="accion" type="hidden" value="Actualizar" name="accion">
                <input id="action" type="submit" value="Confirmar Cambios" name="action">
                    <span></span>
                    <span></span>
                    <span></span>
                    <span></span>
