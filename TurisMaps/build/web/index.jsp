...
<html lang="es">
    ...
    <body>
                            ...
                            <li class="nav-item" id="liNav">
                                <div class="input-group mb-3" id ="botonsesion">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="secure/inicio/registro.jsp?accion=Nuevo">Crear cuenta</a></li>
                                    </ul>   
                                        <%
                                    }
        ...
        <div id="mapa" class="framesito"><iframe src="secure/mapa/mapa.jsp" title="mapa"></iframe></div>
